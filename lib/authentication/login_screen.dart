...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final googleSignInButton = ElevatedButton.icon(
      onPressed: () {
        authService.handleSignIn(); // Make sure this method is correct in your AuthService
      },
      icon: Center(
        child: Image.asset(
          "assets/logo_google.png", // Replace with the path to your Google icon asset
      ...
      style: ElevatedButton.styleFrom(
        ...
        padding: EdgeInsets.symmetric(horizontal: 60.0), // Adjust the padding
      ),
    );
